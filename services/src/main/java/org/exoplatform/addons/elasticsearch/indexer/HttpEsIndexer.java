...
public class HttpEsIndexer extends IndexingService {
    ...
    public static final String port = (System.getProperty("elasticsearch.port") != null) ?
            System.getProperty("elasticsearch.port") : "8080";
    public static final String webapp = (System.getProperty("elasticsearch.webapp") != null) ?
            System.getProperty("elasticsearch.webapp") : "elasticsearch-war";
    ...
    public void add(SearchEntry searchEntry) {
        ...
        try {
            ...
            HttpPost request = new HttpPost("http://" + host + ":" + port + "/" + webapp + "/" + index + "/" + type + "/" + id);
